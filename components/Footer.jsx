...
const Footer = () => {
  ...
  const linkSections = [
    ...
    },
    {
      title: "CONTACT",
      links: [
        { text: "+234 8074602167", path: "/", icon: MailIcon },
        {
          text: "info.elytoltechnologies@gmail.com",
          path: "/",
          icon: PhoneIcon,
        },
        {
          text: "18, Anibaba street, Ketu, Lagos ",
          path: "/",
          icon: MapPinIcon,
        },
      ],
    ...
    <footer className="mx-6 bg-white">
      <div className="max-w-7xl mx-auto">
        ...
        <p className="py-4 text-sm text-slate-500">
          Copyright 2025 © Untamed-Layouts All Right Reserved.
        </p>
      </div>
    </footer>
  );
